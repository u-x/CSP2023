...
to become-immune ;; turtle procedure
  set sick? false
  set sick-time 0
  set remaining-immunity random max-immunity-duration
end
...
to recover-or-die ;; turtle procedure
  if sick-time > virus-duration                        ;; If the turtle has survived past the virus' duration, then
