...
green_frame = tk.Frame(root, background="#00FF00", width=75, height=100)
...
yellow_frame = tk.Frame(root, background="#FFFF00", width=75, height=100)
yellow_frame.grid(row=1, column=1, sticky="news")

firstwidg = tk.Scale(root, orient='horizontal')
firstwidg.grid(row=0, column=0, sticky='news')
